...
export default function ChooseUserType() {
    ...
    return (
        ...
        <div className="flex flex-col justify-center mt-12 my-8">
            <button className="block mx-auto w-64 text-blue-700 bg-white p-3 rounded-lg text-xl mb-6 font-bold hover:bg-gray-100">
                <Link href={"./AdminLogin"}>ADMIN</Link></button>

            <button className="block mx-auto w-64 text-blue-700 bg-white p-3 rounded-lg text-xl text-center mb-6 font-bold hover:bg-gray-100">
                <Link href={"./DriverLogin"}>DRIVER</Link></button>
        </div>
